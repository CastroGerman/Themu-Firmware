...
#define tMPU6050_STACK_SIZE     configMINIMAL_STACK_SIZE*2
#define tBLE_STACK_SIZE         configMINIMAL_STACK_SIZE
#define tGESTURES_STACK_SIZE    configMINIMAL_STACK_SIZE*2
