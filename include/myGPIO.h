...
#define FLEX1_CHANNEL_ATT   ADC_ATTEN_DB_0
#define FLEX2_CHANNEL_ATT   ADC_ATTEN_DB_2_5
#define FLEX3_CHANNEL_ATT   ADC_ATTEN_DB_6
#define FLEX4_CHANNEL_ATT   ADC_ATTEN_DB_11
#define FLEX5_CHANNEL_ATT   ADC_ATTEN_DB_11
